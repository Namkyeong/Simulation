...
extern void  list_check(int option, int list);
...
extern float generate1(int stream);
extern float generate2(int stream);
extern float generate3(int stream);
extern float generate_service(int stream);
